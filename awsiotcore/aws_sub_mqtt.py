...
class PubSub(object):
    ...
    def __on_connect(self, client, userdata, flags, rc):
        self.connect = True
        print("hey on connect")
        if self.listener:
            self.mqttc.subscribe(self.topic, qos=1)
        print("am here after subscribe")
    ...
    def bootstrap_mqtt(self):
        ...
        print("already set certificates")
    ...
    def start(self):
        ...
        while True:
            ...
            if self.connect == True:
                ...
                self.mqttc.publish(self.topic, json.dumps({"message": "Hello the second"}), qos=1)
                print("after puublish", flush=True)
            else:
